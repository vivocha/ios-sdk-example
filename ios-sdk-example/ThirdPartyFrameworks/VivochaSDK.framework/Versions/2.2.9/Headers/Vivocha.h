...
/**
 *  Disables the Location feature for the app.
 */
- (void) disableLocationFeature;

/**
 * Disables the Screenshot feature for the app.
 */

- (void) disableScreenshotFeature;

/**
 * Disables the Canned Question feature for the app.
 */
- (void) disableCannedQuestionFeature;

/**
 * Disables the Audio/Video functionality.
 */
...
/**
 * Force Vivocha to use a different language instead of the system's one.
 ...
 *
 *  @param logoImage    the UIImage object.
 */
+ (void) setChatHeaderImage:(UIImage *)logoImage;

/**
 *  Adds a new translation to the Vivocha UI.
 *
...
+ (void) createVideoChatWithDataCollection:(VivochaDataCollection *)dataCollection;
+ (void) createVideoChatWithDataCollection:(VivochaDataCollection *)dataCollection andCompletionBlock:(void (^)(VivochaContact *))completionBlock;
@end
